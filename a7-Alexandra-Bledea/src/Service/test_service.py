import unittest
from src.Service.service import StudentService, DisciplineService, GradeService, AverageStudentsStatistic, \
    GeneralAverageStudentsStatistic, AverageDisciplineStatistic
...
class DisciplineServiceTest(unittest.TestCase):
    ...
    def test_append_discipline_to_list(self):
        discplines_repo = DisciplineRepository()
        disciplines_service = DisciplineService(discplines_repo)
...
class GradeServiceTest(unittest.TestCase):
    ...
    def test_append_grade_to_student(self):
        ...
        students_service = StudentService(students_repo)
        disciplines_service = DisciplineService(disciplines_repo)
        grades_service = GradeService(disciplines_repo, students_repo, grades_repo)
    ...
    def test_calculate_average(self):
        ...
        student_service = StudentService(student_repo, False)
        discipline_service = DisciplineService(discipline_repo, False)
        grade_service = GradeService(discipline_repo, student_repo, grade_repo, False)
