...
class Console:
    ...
    def display_all_students_who_failed_ui(self):
        ...
        """
        result = self.grade_service.calculate_average()
        result = IterableObject.filter(result, lambda a: a.average_a < 5)
        for average in result:
            print(average)
    ...
    def search_student_by_name_ui(self):
        ...
        list_students = self.students_service.search_student_by_name(name)
    ...
    def search_student_by_id_ui(self):
        ...
        list_students = self.students_service.search_student_by_id(student_id)
        for student in list_students:
            print(student)
    ...
    def search_discipline_by_name_ui(self):
        ...
        """
        name = input("Enter the name: ")
        list_disciplines = self.discipline_service.search_discipline_by_name(name)
    ...
    def search_discipline_by_id_ui(self):
        ...
        list_disciplines = self.discipline_service.search_discipline_by_id(discipline_id)
        for discipline in list_disciplines:
            print(discipline)
