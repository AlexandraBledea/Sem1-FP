...
class StudentService:
    ...
    def search_student_by_name(self, name):
        ...
        list_students = IterableObject.filter(self.students.student_list, lambda student: name in student.student_name
                                              .lower())
        if len(list_students) != 0:
            return list_students
        else:
            raise StudentException("There was no student found!")
    ...
    def search_student_by_id(self, student_id):
        ...
        list_students = IterableObject.filter(self.students.student_list, lambda student: student_id in student.
                                              student_id)
        if len(list_students) != 0:
            return list_students
        else:
    ...
    def sort_students_list(self):
        ...
        :return: it doesn't return anything
        """
        IterableObject.sort(self.students.student_list, lambda s1, s2: s1.student_id >= s2.student_id)
