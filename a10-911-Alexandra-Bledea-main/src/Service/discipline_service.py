...
class DisciplineService:
    ...
    def search_discipline_by_name(self, name):
        ...
        list_disciplines = IterableObject.filter(self.disciplines.discipline_list, lambda discipline: name in
                                                 discipline.discipline_name.lower())
        if len(list_disciplines) != 0:
            return list_disciplines
        else:
            raise DisciplineException("There was no discipline found!")
    ...
    def search_discipline_by_id(self, discipline_id):
        ...
        list_disciplines = IterableObject.filter(self.disciplines.discipline_list, lambda discipline: discipline_id in
                                                 discipline.discipline_id)
    ...
    def sort_disciplines_list(self):
        ...
        :return: It doesn't return anything
        """
        IterableObject.sort(self.disciplines.discipline_list, lambda discipline1, discipline2: discipline1.discipline_id
