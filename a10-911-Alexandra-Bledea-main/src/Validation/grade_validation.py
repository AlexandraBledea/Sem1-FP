...
class GradeValidation:
    ...
    def check_existence_of_grade_student(student_id, grade_list):
        ...
        """
        existent = False
        for grade in range(grade_list):
            if grade_list[grade].student_id_g == student_id:
                existent = True
        if not existent:
    ...
    def check_the_existence_of_grade_discipline(discipline_id, grade_list):
        ...
        """
        existent = False
        for grade in range(len(grade_list)):
            if grade_list[grade].discipline_id_g == discipline_id:
                existent = True
        if not existent:
